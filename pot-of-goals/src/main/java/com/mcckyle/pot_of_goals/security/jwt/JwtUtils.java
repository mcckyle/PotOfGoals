...
package com.mcckyle.pot_of_goals.security.jwt;
...
public class JwtUtils
{
                                   ...
                                   Collection<? extends GrantedAuthority> authorities)
    {
        ...
        return Jwts.builder()
                .issuer("pot_of_goals_app")
                .audience().add("pot_of_goals_app-client").and()
                .id(jti)
    ...
    public Claims getClaimsFromToken(String token)
    {
        ...
        {
            return Jwts.parser()
                    .requireIssuer("pot_of_goals_app")
                    .requireAudience("pot_of_goals_app-client")
